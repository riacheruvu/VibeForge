...
This public-safe case study shows the core VibeForge loop:
...
```bash
node skills/vibeforge/scripts/mine-conversation-history.mjs \
...
node skills/vibeforge/scripts/promote-history-candidates.mjs \
