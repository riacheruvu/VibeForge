...
function runCase(caseId) {
  ...
  runNode([
    "skills/vibeforge/scripts/mine-conversation-history.mjs",
  ...
  runNode([
    "skills/vibeforge/scripts/promote-history-candidates.mjs",
  ...
  runNode([
    "skills/vibeforge/scripts/score-answers.mjs",
  ...
  runNode([
    "skills/vibeforge/scripts/gate-config-results.mjs",
  ...
  runNode([
    "skills/vibeforge/scripts/chart-results.mjs",
